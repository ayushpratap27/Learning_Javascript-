...
// Different syntax using async
async function consumePromiseFive(){ // try & catch block if there is a chance of error
    try {
...
// there's permissions issue or similar). a fetch() promise does not reject on HTTP errors (404, etc).
